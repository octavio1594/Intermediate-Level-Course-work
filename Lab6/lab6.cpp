...
int main()
{
	...
	SubAB = B - A;// call a function to operator-  to subtract Matrix A from Matrix B  and place the result into Matrix SubAB
	...
	cout << "File A contains:" << endl;
	cout << A << endl;
	cout << "File B contains:" << endl;
	cout << B << endl;
	cout << "File A + File B:" << endl;
	cout << AddAB << endl;
	cout << "File A - File B:" << endl;
	cout << SubAB << endl;
	cout << "File A * File B:" << endl;
